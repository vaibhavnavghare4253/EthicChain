    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-white">CharityChain</span>
            </div>
            <p className="text-sm">
              Transparent blockchain-based charity platform. Every donation tracked on-chain.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/campaigns" className="hover:text-primary-400">Browse Campaigns</Link></li>
              <li><Link href="/create" className="hover:text-primary-400">Create Campaign</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} CharityChain. All rights reserved. Built with transparency on blockchain.</p>
        </div>
      </div>
    </footer>
  );
